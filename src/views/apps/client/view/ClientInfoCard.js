            ...
            <div className='d-flex align-items-center flex-column'>
              ...
              <div className='d-flex flex-column align-items-center text-center'>
                <div className='user-info'>
                  <h4>{selectedClient !== null ? selectedClient.Name.concat(' '+selectedClient.Surname) : 'Eleanor Aguilar'}</h4>
                  {selectedClient !== null ? (
                    <Badge color={roleColors[selectedClient.Rol]} className='text-capitalize'>
                      {selectedClient.Rol}
                    </Badge>
                  ) : null}
                </div>
            ...
            <Row className='gy-1 pt-75'>
              <Col md={6} xs={12}>
                ...
                <Controller
                  ...
                  name='Name'
                  render={({ field }) => (
                    <Input {...field} id='Name' placeholder='Marta' invalid={errors.firstName && true} />
                  )}
                />
              </Col>
              <Col md={6} xs={12}>
                ...
                <Controller
                  ...
                  name='Surname'
                  render={({ field }) => (
                    <Input {...field} id='Surname' placeholder='Torres' invalid={errors.lastName && true} />
                  )}
                />
              </Col>
              <Col xs={12}>
                ...
                <Controller
                  ...
                  name='Email'
                  render={({ field }) => (
                    <Input {...field} type='email' id='Email' placeholder='nombre@gmail.com' invalid={errors.Email && true} />
                  )}
                />
              </Col>
              <Col md={6} xs={12}>
              ...
              <Col md={6} xs={12}>
                <Label className='form-label' for='Teléfono'>
                  Teléfono
                </Label>
                <Input id='Teléfono' defaultValue={selectedClient.Phone} placeholder='609 933 442' />
              </Col>
