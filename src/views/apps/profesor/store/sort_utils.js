/**
 * Function to sort and filter the Profesor list
 * @param {*} params to filter and sort the Profesor list
 * @param {*} response list of Profesor to sort and filter
 * @returns return a Profesor list filtered and sorted
 */
